...
from procthor_v2.constants import USE_ITHOR_SPLITS
from procthor_v2.utils.types import Split
...
def get_spawnable_asset_group_info(
    ...
    from procthor_v2.generation.asset_groups import AssetGroupGenerator
